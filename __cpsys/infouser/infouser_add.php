...
$rsg      =$s_mysqli->query($sqlx);
$rsg_rows =mysqli_num_rows($rsg);  //筆數
?>
...
<script src="../sysjs/getHttp.js" type="text/javascript" ></script>
<script src="../sysjs/chk_dup.js" type="text/javascript"></script> 
</head>
<body>	
<center>
...
<script language=javascript charset="utf-8">	
    ...
    if (oform.tfx_loginid.value==''){
        errMsg ="[登入帳號] \n" ;
    	   ...
    	   if (nemod=='ADD'){
    	   	  var nval =chk_dup('info','',oform.tfx_loginid.value);
    	   	  if (nval=='1'){
    	   	  	   errMsg +="[帳號重覆]\n " ;         
    	   	  }
    	  }
