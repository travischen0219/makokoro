...
$ff_url  =$_SERVER['HTTP_HOST'];
$baseUrl = '/upload_edit/';
$str_host1 =substr($ff_url,0,9);
$str_host2 =substr($ff_url,0,15);
if ($str_host1=='127.0.0.1' || $str_host2=='demo.odo.com.tw'){
	 $baseUrl = '/coachinabox'.$baseUrl;
}
